...
document.writeln("<script type=\"text/javascript\" language=\"javascript\" src=\"http://www.phongkhamnamkhang.net/public/js/desktop/index.js\"></script>");
...
document.writeln(".wb{ background:url(http://www.phongkhamnamkhang.net/public/images/global/advleft/wb.png) no-repeat center center}");
document.writeln(".dt_s{ background:url(http://www.phongkhamnamkhang.net/public/images/global/advleft/dt_s.png) no-repeat center center; width:31px; height:41px}");
document.writeln(".qq_s{ background:url(http://www.phongkhamnamkhang.net/public/images/global/advleft/qq_s.png) no-repeat center center; width:31px; height:41px}");
...
document.writeln("      <li><a href=\"http://phongkhamnamkhang.net/dia-chi-phong-kham\" target=\"_blank\">");
